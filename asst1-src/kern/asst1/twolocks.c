...
********************************************************************************/
/* locka has higher precendence than lockb. 
   the ordering is such, if a process requires both locks at the same time, 
   locka is always acquired before lockb. This way, deadlocks cannot occur
   (as per the resource ordering scheme) */
